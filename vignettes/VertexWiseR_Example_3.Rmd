...
Since [SubCortexMesh v.1.1.0](https://subcortexmesh.readthedocs.io/en/latest/atlases.html), anatomical sub-parcellations are also available for surfaces in fsaverage space, and give more specific location in regions' nuclei or subfields. VertexWiseR can use them with the argument 'atlas=2' (the caudate nuclei do not have such precise parcellations, so we show it for the thalami):
