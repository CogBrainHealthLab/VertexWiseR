...
As of version 1.4.1, 5 functions in VertexWiseR do surface data extraction and synthesis:
...
FSLRvextract() extracts cortical data in FSLR32k surface space from Human Connectome Project (HCP) [@van_essen_wu-minn_2013], fMRIprep [@esteban_fmriprep_2019] preprocessing output directories, as well as XCP-D [@mehta2024xcp] postprocessing output directories.
