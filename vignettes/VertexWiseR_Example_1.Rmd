...
To obtain it, we had extracted cortical thickness (CT) data from a FreeSurfer preprocessing directory of the [SPRENG dataset](https://openneuro.org/datasets/ds003592/versions/1.0.13) [@spreng_neurocognitive_2022]. Here is the command line which was used to extract it:
...
In this demo, the surface data can be loaded straight from the online repository and then smoothed:
