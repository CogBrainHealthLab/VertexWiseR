...
The following commented out code is the script which was used to produce this demo data with the SPRENG dataset:
...
The SPRENG behavioural data (SPRENG_behdata_site1.csv) is accessible from the VertexWiseR package internal data:
...
model1_RFT=RFT_vertex_analysis(model = dat_beh[,c("gender","age")], 
...
model1_TFCE=TFCE_vertex_analysis(model= dat_beh[,c("gender","age")], 
