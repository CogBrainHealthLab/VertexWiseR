...
#' @title fs_stats()
#'
#' @description Extracts descriptive statistics of subjects within a FreeSurfer subjects directory. It reads them from the aseg.stats file, as generated by the default FreeSurfer preprocessing pipeline.
#'
...
fs_stats=function(sdirpath="./", sublist) {
